...
export default function CandidateResult() {
    ...
    if (loading) return (
        <div className="min-h-screen bg-[#020204] flex flex-col items-center justify-center font-cyber text-teal-400 overflow-hidden relative">
            ...
            <div className="tracking-[0.8em] animate-pulse text-[10px] font-bold uppercase text-slate-500">Generating_Integrity_Report...</div>
        </div>
    );

    if (!result) return (
        <div className="min-h-screen bg-[#020204] flex flex-col items-center justify-center p-12 font-cyber text-center relative overflow-hidden">
            <div className="noise-overlay" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-16">
                    ...
                    <div className="md:col-span-8 glass-card p-10 flex flex-col md:flex-row items-center gap-12 border-teal-500/10 bg-gradient-to-br from-teal-500/5 to-transparent relative group">
                        ...
                        <div className="relative w-56 h-56 flex-shrink-0">
                            ...
                            <div className="absolute inset-0 flex flex-col items-center justify-center font-cyber italic pointer-events-none opacity-50 mix-blend-overlay">
                                <span className="text-6xl font-black text-teal-500 leading-none tracking-tighter tabular-nums">{score}</span>
                            </div>
                        </div>
                        <div className="flex-1 space-y-8 py-2">
                            <div>
                                ...
                                <p className="text-xs text-gray-400 font-sans leading-loose font-bold italic">
                            ...
                            <div className="flex flex-wrap gap-5 pt-5 border-t border-white/5">
                                <div className="flex flex-col">
                                    <span className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-0.5">DESIGNATION:</span>
                                    <span className="text-xs font-black text-teal-400 uppercase italic tracking-tighter shadow-glow-teal">ELITE_SYSTEMS_NODE</span>
                                </div>
                                <div className="flex flex-col">
                                    <span className="text-[9px] font-black text-gray-600 uppercase tracking-widest mb-0.5">GLOBAL_RANK:</span>
                    ...
                    {/* Security Snapshot */}
                    <div className="md:col-span-4 glass-card p-10 border-white/5 bg-[#020204]/60 flex flex-col items-center justify-between text-center group">
                        <div className="p-5 bg-white/[0.02] border border-white/5 rounded-3xl group-hover:border-teal-500/20 transition-all duration-700">
                            <Fingerprint size={36} className="text-teal-500/40 group-hover:scale-110 group-hover:text-teal-400 transition-all duration-700 drop-shadow-[0_0_10px_rgba(20,184,166,0.3)]" />
                        </div>
                        <div className="space-y-3">
                            <h3 className="text-[9px] font-black text-white uppercase tracking-[0.4em] font-cyber">AUTH_VERIFIED</h3>
                            <div className="px-4 py-1.5 bg-green-500/10 border border-green-500/20 text-green-400 rounded-xl inline-flex items-center gap-2 shadow-[0_0_20px_rgba(34,197,94,0.1)]">
                                <Lock size={10} />
                                <span className="text-[9px] font-black uppercase tracking-widest">GATEWAY_SECURE</span>
                            </div>
                        </div>
                        <p className="text-[9px] text-gray-500 font-mono font-bold uppercase tracking-tight leading-relaxed">FINGERPRINT_MATCH: POSITIVE<br />ENCRYPTION: AES_256<br />IP_GEOLOCATION: STABLE</p>
                    </div>
                </div>
