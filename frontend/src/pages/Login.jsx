...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-[var(--bg-primary)] relative flex items-center justify-center p-6 overflow-hidden transition-colors duration-300">
            ...
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-[600px] bg-glow-teal opacity-20 dark:opacity-30 pointer-events-none" />

            <div className="w-full max-w-[440px] relative z-10">
                <div className="glass-card overflow-hidden">
                    {/* HUD Header */}
                    <div className="px-6 py-4 border-b border-[var(--border-primary)] bg-[var(--bg-secondary)] flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="flex gap-1">
                                <div className="w-1 h-1 rounded-full bg-teal-500 animate-pulse" />
                                <div className="w-1 h-1 rounded-full bg-teal-500/20" />
                            </div>
                            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-[var(--text-secondary)] font-cyber">Auth_Protocol_v3</span>
                        </div>
                    ...
                    <div className="p-10 space-y-8">
                        <div className="text-center space-y-4">
                            <div className="mx-auto w-16 h-16 bg-teal-500/10 flex items-center justify-center rounded-2xl border border-teal-500/20 shadow-sm mb-6">
                                <Fingerprint className="text-teal-600 dark:text-teal-400" size={32} />
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-teal-600 dark:text-teal-400/80 uppercase tracking-widest ml-1 font-cyber">IDENTIFIER</label>
                            ...
                            <div className="space-y-2">
                                <label className="text-[10px] font-bold text-teal-600 dark:text-teal-400/80 uppercase tracking-widest ml-1 font-cyber">PASSPHRASE</label>
                                <div className="relative">
                        ...
                        <div className="text-center">
                            <Link to="/register" className="text-[10px] text-[var(--text-secondary)] hover:text-teal-600 dark:hover:text-teal-400 transition-colors uppercase font-bold tracking-widest font-cyber italic border-b border-transparent hover:border-teal-500/50 pb-1">
                                Initialize_New_Node
                            </Link>
                        </div>
                    </div>
                ...
                {/* Technical Footer */}
                <div className="mt-8 flex justify-between items-center px-2 text-[10px] uppercase font-bold tracking-[0.4em] text-[var(--text-secondary)] font-cyber italic opacity-50">
