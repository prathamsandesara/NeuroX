                ...
                <div className="glass-card p-0 bg-black/60 border-teal-500/20 shadow-[0_50px_100px_rgba(0,0,0,0.8)] overflow-hidden group">
                    ...
                    <div className="px-6 py-4 border-b border-white/5 bg-white/[0.02] flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[9px] font-black text-gray-600 uppercase tracking-[0.4em] font-cyber ml-2">Identity_Handshake_v2.5</span>
                        </div>
                        <div className="flex items-center gap-1.5">
                            <Lock size={10} className="text-teal-500/50" />
                            <span className="text-[8px] text-gray-700 font-black uppercase tracking-widest">TLS_SECURE_L4</span>
                        </div>
                    </div>
                    ...
                    <div className="p-10 md:p-14 space-y-10 relative">
                        ...
                        <div className="text-center space-y-5 relative z-10">
                            <div className="mx-auto w-16 h-16 bg-teal-500 flex items-center justify-center rounded-[1.5rem] shadow-[0_0_40px_rgba(20,184,166,0.4)] transition-transform duration-700 group-hover:scale-110 mb-6 border border-white/10">
                                <Key className="text-black" size={32} />
                            </div>
                            <h1 className="text-4xl font-black text-white italic tracking-tighter uppercase font-cyber leading-none">VERIFY_STUB</h1>
                            <div className="flex flex-col items-center gap-2 px-6">
                                <p className="text-[10px] text-gray-600 uppercase tracking-[0.4em] font-black">Decrypting Node Identity For:</p>
                                <div className="px-4 py-1.5 bg-teal-500/5 border border-teal-500/20 rounded-xl">
                                    <span className="text-[10px] text-teal-500 font-black uppercase tracking-widest font-mono italic">{email || 'UNKNOWN_NODE'}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                            <div className="space-y-3 pt-4">
                                <div className="flex justify-between items-center ml-2 mb-2">
                                    <label className="text-[10px] font-black text-teal-400 uppercase tracking-[0.4em] font-cyber italic">INPUT_DECRYPTION_TOKEN:</label>
                                    <Activity size={10} className="text-teal-500/50 animate-pulse" />
                                </div>
                                <input
                                    type="text"
                                    maxLength="6"
                                    className="w-full text-center text-4xl font-black tracking-[0.6em] font-cyber py-8 bg-black/60 border border-white/5 focus:border-teal-500/40 text-white rounded-[1.5rem] transition-all duration-500 outline-none shadow-inner placeholder:text-gray-900 group-hover:border-teal-500/20"
                                    placeholder="000000"
                                    value={otp}
                                    onChange={e => setOtp(e.target.value)}
                                    required
                                />
                                <div className="flex items-center justify-center gap-2 pt-3 text-gray-700 font-bold uppercase text-[8px] tracking-widest">
                                    <MessageSquare size={10} className="text-gray-800" />
                            ...
                            <button
                                ...
                                className={`w-full py-4 text-sm font-black italic tracking-widest flex items-center justify-center gap-3 mt-4 transition-all duration-700 rounded-xl shadow-2xl group/btn ${loading || otp.length < 6 ? 'bg-white/5 border border-white/5 text-gray-700 opacity-50' : 'bg-teal-500 hover:bg-teal-400 text-black shadow-[0_20px_40px_rgba(20,184,166,0.3)] active:scale-95'}`}
                            >
                                {loading ? (
                        ...
                        <div className="text-center pt-6 relative z-10 group/abort">
                            <Link to="/login" className="inline-flex items-center gap-2 text-[10px] text-gray-700 hover:text-red-500 transition-all duration-500 uppercase font-black tracking-[0.4em] font-cyber italic border-b border-transparent hover:border-red-500/30 pb-2">
                                <span className="text-red-500 opacity-50 group-hover/abort:opacity-100 transition-opacity">&gt;</span> ABORT_VERIFICATION_PROTOCOL
                            </Link>

                            <div className="flex items-center justify-center gap-8 pt-12 border-t border-white/5 opacity-20">
                                ...
                                <div className="flex flex-col items-center gap-2 transition-opacity hover:opacity-100">
                                    <Radar size={14} className="text-gray-500" />
